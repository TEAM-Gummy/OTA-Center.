...
if (!isset($_SESSION['user_id'])) {
    if (isset($_POST['registreer_submit'])) {
        ...
        $recaptcha_resp = recaptcha_check_answer($recaptcha_privkey,
                $_SERVER["REMOTE_ADDR"],
...
EOF;
            ...
            echo 'You failed to answer the recaptcha challenge properly! ('.$recaptcha_resp->error.')';
        }
    } else {
        // Formulier
            ...
            <form id="register_form" action="?page=registreer" method="post">
                <fieldset>
                    ...
                    <p>
                        <?
                        require_once 'recaptchalib.php';
                        echo recaptcha_get_html($recaptcha_pubkey, null, true);
                        ?>
                    </p>
                    <p>
